...
Runtime configuration lives in the ignored `config.json`. SQLite and screenshots live in the ignored `data/` directory. Back up those two runtime paths outside version control.
